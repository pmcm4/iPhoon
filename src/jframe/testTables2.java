 ...
 * @author pmora
 */
public class testTables2 extends javax.swing.JFrame {
    ...
    public testTables2() {
     ...
     public void nooflad(){
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("SELECT TyphoonID, BagyoName, InterName, category, COUNT(Area_ID) as totarea\n" +
"from typhoon as a, affected as b, signal_cat as c\n" +
"WHERE a.TyphoonID = b.Typhoon_No AND a.SignalNumber = c.signal_no\n" +
"GROUP BY 1");
             DecimalFormat df = new DecimalFormat("$#,##0;(#,##0)"); 
            while (rs.next()) {
               int tid = rs.getInt("TyphoonID");
               String bname = rs.getString("BagyoName");
               String iname = rs.getString("InterName");
               String cname = rs.getString("category");
               int areal = rs.getInt("totarea");
               
                Object[] obj = {tid, bname, iname, cname, areal};
     ...
     public void nooflad2(){
        ...
        try{
            ...
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT Year, BagyoName\n" +
"	   FROM typhoon\n" +
"	   WHERE (SignalNumber IN(1, 2, 3) AND Total_Fatal = 0) OR (SignalNumber IN(4, 5) AND Total_Fatal >= 100)");
             DecimalFormat df = new DecimalFormat("$#,##0;(#,##0)"); 
            while (rs.next()) {
               int yyyy = rs.getInt("year");
               String bagyo = rs.getString("BagyoName");

               
                Object[] obj = {yyyy, bagyo};
    ...
    private void initComponents() {
        ...
        lad.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Typhoon ID", "Bagyo Name", "Int'l Name", "Category", "No. of Affected Areas"
            }
        ));
        ...
        jLabel2.setText("or if the signal number is 4 and 5, the total fatalities should be greater than or equal to 100.");
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 320, 550, 24));
        ...
        jLabel4.setText("Displays the total count of affected areas in each Typhoon. ");
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 70, 480, 24));

        jLabel6.setText("Display the year and local name of typhoon if the signal number is between 1 and 3, with zero record of fatalities ");
        jPanel4.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 300, 700, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(testTables2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
