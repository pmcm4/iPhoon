 ...
 * @author pmora
 */
public class testTables4 extends javax.swing.JFrame {
...
"	  FROM typhoon\n" +
"	  WHERE intername NOT LIKE '%"+input.getText()+"%' OR bagyoname NOT LIKE '%"+input.getText()+"%'");
    ...
    private void initComponents() {
        ...
        materialButton6.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jLabel4.setText("Display the year, international and local names where either of the names doesn't have the letter defined by the user.");
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 70, 700, 24));
...
"	  WHERE intername NOT LIKE '%"+input.getText()+"%' OR bagyoname NOT LIKE '%"+input.getText()+"%'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(testTables4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
